...
attribute :default_listener, kind_of: String,    default: node['vulcand']['run_opts']['default_listener']
...
attribute :etcdSyncIntervalSeconds, kind_of: String, default: node['vulcand']['run_opts']['etcdSyncIntervalSeconds']
...
attribute :port, kind_of: String,                default: node['vulcand']['run_opts']['port']
...
attribute :serverMaxHeaderBytes, kind_of: String, default: node['vulcand']['run_opts']['serverMaxHeaderBytes']
